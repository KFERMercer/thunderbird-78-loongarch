...
add_task(async function setup() {
  ...
  subFolders.test1.markMessagesRead(
    toXPCOMArray([messages[0]], Ci.nsIMutableArray),
    true
  );
  subFolders.test1.markMessagesFlagged(
    toXPCOMArray([messages[1]], Ci.nsIMutableArray),
    true
  );
  subFolders.test1.markMessagesFlagged(
    toXPCOMArray([messages[6]], Ci.nsIMutableArray),
    true
  );
